...
const x5bz4 = [
   ...
   '*** انشاء الله نحاول نكملها او ننزل حاجه تانيه مختلفه وبس شكرآ ***',
]
...
client.on('message', msg => {
  if (msg.content === 'ق2') {
    msg.reply('لم يتم اضافة القوانين رقم 2 او ق2 لعدم وجود قوانين كثير اذا كنت عاوز تدعمنا او توصل لصاحب البوت واعطائنا افكارك تواصل اكتب الامر ^support');
  }
});
...
client.on('message', msg => {
  if (msg.content === 'هتلعب') {
	 (msg.content === 'مين هيلعب')
    msg.reply('الشياطين لا يمزحون ._.');
  }
});
...
client.on("message", message => {
 if (message.content === "^help") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© DemonsBlack')
      .setFooter('اوامر الادمن')
	  .addField('^bc', `خاصية البرودكاست`)
      .setFooter('======================================================')
      .setFooter('اوامر الاعضاء')
      .addField('^invite', `لاضافة البوت الى سيرفرك`)
      .addField('^avatar', `للحصول علي صورتك`)
      .addField('^2avatar', `تاخد افتار عن طريق منشن لشخص `)
	  .addField('^server', `معلومات السيرفر`)
	  .addField('^id', `الملف الشخصي `)
	  .addField('^clear', `مسح 100 رسالة`)
	  .addField('^say', `البوت يكرر الكلام الي انت تقوله`)
	  .addField('^ping', `يقلك كم بنج البوت`)
...
client.on("message", message => {
 if (message.content === "^invite") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© DemonsBlack')
      .addField('لينك دعوة البوت الي سيرفرك', `https://discordapp.com/oauth2/authorize?client_id=505030742871375880&permissions=0&scope=bot`)
  message.author.send({embed});
...
client.on("message", message => {
 if (message.content === "^support") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© DemonsBlack')  
      .addField('سيرفر الدعم الفني', `  https://discord.gg/9yGUUmZ  `)
  message.author.send({embed});
...
const TOKEN = "NTA1MDMwNzQyODcxMzc1ODgw.DrNvZQ.6zRCwzRXXqJ3Rd_XpQzAx4aCy7M";
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`---------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setGame(`DemonsBlack`,"http://twitch.tv/RameRaafat")
...
client.on("message", message => {
    var prefix = "^";
            ...
            if (message.content.startsWith(prefix ^ "clear")) {
				if(!message.channel.guild) return;
   if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('⚠ | ***معندكش رول ^^***');
        var msg;
        msg = parseInt();
...
client.login("NTA1MDMwNzQyODcxMzc1ODgw.DrNvZQ.6zRCwzRXXqJ3Rd_XpQzAx4aCy7M");
